...
specs:
  - "Fertilizer Channels: 3 (independent, adjustable with flow meters)"
  - "Solenoid Valve Control: 1 pump + 4–8 valves (expandable)"
  - "Pump Capacity: 10–15 m³/h, Head Lift: 80 meters"
  - "Voltage: 380V AC (220V optional)"
  - "Port Size: DE32 / DE40 (customizable)"
  - "Cloud Platform Support: Optional remote access via mobile/PC"
  - "Control Interface: 7\" color touchscreen + physical buttons"
  - "Structure: Aluminum frame + UPVC piping"
