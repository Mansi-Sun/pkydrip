...
<div>
  ...
  <section class="custom-section">
    ...
    <ul>
      ...
      <li><p><strong>Wireless field devices:</strong> LoRa valve controllers and sensor reporting in real time.</p></li>
      <li><p><strong>Integration view:</strong> how the platform connects to third-party systems (e.g. ThingsBoard) and what the open documentation covers.</p></li>
      <li><p><strong>Your questions:</strong> pricing, MOQ, OEM options and regional availability — answered live.</p></li>
    </ul>
  </section>

  <!-- TODO: 云平台演示租户上线后，在此嵌入 Cal.com 预约日历：
       <iframe src="https://cal.com/pkydrip/demo" style="min-height:680px;width:100%;border:0;"></iframe>
  ...
  <section class="custom-section">
    ...
    <ul>
      ...
      <li><p><strong>3.</strong> You get a meeting link; bring your technical questions — our product engineer joins the call.</p></li>
    </ul>
  </section>

  <div class="text-center mt-5">
    <a class="btn btn-success btn-lg"
       href="https://wa.me/8617395297329?text=Hi%20PKYDRIP%2C%20I%27d%20like%20to%20book%20a%20live%20demo%20of%20the%20cloud%20platform."
